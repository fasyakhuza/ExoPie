...
h_FJetMassBkgL_final = TH1F("h_FJetMassBkgL_final","Background FJetMass Loose",30,0,300)
h_FJetMassBkgM1_final = TH1F("h_FJetMassBkgM1_final","Background FJetMass Medium1",30,0,300)
h_FJetMassBkgM2_final = TH1F("h_FJetMassBkgM2_final","Background FJetMass Medium2",30,0,300)
...
h_FJetMassBkgL_final.GetXaxis().SetTitle("Fat Jet Mass")
