...
for i in range(len(fname)):
    ...
    h_total_mcweight = openf.Get("h_total_mcweight")
    preEvents = h_total_mcweight.Integral()
    treef = openf.Get("monoHbb_SR_boosted")
    events = treef.GetEntries()
...
gr3.GetYaxis().SetTitleOffset(2.0)
