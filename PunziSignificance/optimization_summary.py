...
for i in range(len(fname)):
    ...
    for j in range(preEvents):
        ...
        if (FJetCSV > 0.7) and (FJetMass > 100.0) and (FJetMass < 150.0) and (abs(dPhi) > 0.4) and (nJets <= 2.0):
            h_FJetMassL[i].Fill(FJetMass)
        if (FJetCSV > 0.86) and (FJetMass > 100.0) and (FJetMass < 150.0) and (abs(dPhi) > 0.4) and (nJets <= 2.0):
            h_FJetMassM1[i].Fill(FJetMass)
        if (FJetCSV > 0.89) and (FJetMass > 100.0) and (FJetMass < 150.0) and (abs(dPhi) > 0.4) and (nJets <= 2.0):
