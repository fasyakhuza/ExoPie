...
bkgname = ["DYJetsToLL_M-50_HT-100to200_TuneCP5_13TeV-madgraphMLM-pythia8.root","DYJetsToLL_M-50_HT-400to600_TuneCP5_13TeV-madgraphMLM-pythia8.root","DYJetsToLL_M-50_HT-600to800_TuneCP5_13TeV-madgraphMLM-pythia8.root","DYJetsToLL_M-50_HT-800to1200_TuneCP5_13TeV-madgraphMLM-pythia8.root","DYJetsToLL_M-50_HT-1200to2500_TuneCP5_13TeV-madgraphMLM-pythia8.root","ZJetsToNuNu_HT-100To200_13TeV-madgraph.root","ZJetsToNuNu_HT-400To600_13TeV-madgraph.root","ZJetsToNuNu_HT-600To800_13TeV-madgraph.root","ZJetsToNuNu_HT-800To1200_13TeV-madgraph.root","ZJetsToNuNu_HT-1200To2500_13TeV-madgraph.root","ZJetsToNuNu_HT-2500ToInf_13TeV-madgraph.root","WJetsToLNu_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8.root","WJetsToLNu_HT-1200To2500_TuneCP5_13TeV-madgraphMLM-pythia8.root","GJets_HT-40To100_TuneCP5_13TeV-madgraphMLM-pythia8.root","GJets_HT-100To200_TuneCP5_13TeV-madgraphMLM-pythia8.root","GJets_HT-200To400_TuneCP5_13TeV-madgraphMLM-pythia8.root","GJets_HT-600ToInf_TuneCP5_13TeV-madgraphMLM-pythia8.root","QCD_HT100to200_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT200to300_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT300to500_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT500to700_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT700to1000_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT1000to1500_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT1500to2000_TuneCP5_13TeV-madgraph-pythia8.root","QCD_HT2000toInf_TuneCP5_13TeV-madgraph-pythia8.root","TTTo2L2Nu_TuneCP5_PSweights_13TeV-powheg-pythia8.root","crab_TTToHadronic_TuneCP5_PSweights_13TeV-powheg-pythia8.root","ST_s-channel_4f_leptonDecays_TuneCP5_13TeV-amcatnlo-pythia8.root","ST_t-channel_antitop_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8.root","ST_t-channel_top_4f_inclusiveDecays_TuneCP5_13TeV-powhegV2-madspin-pythia8.root","ST_tW_antitop_5f_inclusiveDecays_TuneCP5_13TeV-powheg-pythia8.root","ZZ_TuneCP5_13TeV-pythia8.root","WZ_TuneCP5_13TeV-pythia8.root"]

xsBkg = [161.1, 6.968, 1.743, 0.8052, 0.1933, 280.35, 10.73, 2.559, 1.1796, 0.28833, 0.006945, 1395.0, 1.074, 20790.0, 9238.0, 2305.0, 93.46, 23700000.0, 1547000.0, 322600.0, 32100.0, 6831.0, 1207.0, 119.9, 25.24, 95.02, 367.83, 3.74, 67.91, 113.3, 34.97, 12.14, 27.6]
MH3name = arr.array('d', [300, 400, 500, 600, 600, 1000, 1200, 1400, 1600])
...
h_FJetMassBfr.SetLineColor(2)
h_FJetMassBfr.SetLineWidth(5)
h_FJetMassBfr.GetXaxis().SetTitle("Fat Jet Mass (GeV)")
h_FJetMassBfr.GetYaxis().SetTitle("Number of Events")
h_FJetMassBfr.GetYaxis().SetNdivisions(505)
h_FJetMassBfr.GetYaxis().SetLabelOffset(1.4)
h_FJetMassBfr.Draw("hist")

h_FJetMassL.SetLineColor(3)
h_FJetMassL.SetLineWidth(5)
h_FJetMassL.Draw("histsame")

h_FJetMassM1.SetLineColor(4)
h_FJetMassM1.SetLineWidth(5)
h_FJetMassM1.Draw("histsame")

h_FJetMassM2.SetLineColor(5)
h_FJetMassM2.SetLineWidth(5)
h_FJetMassM2.Draw("histsame")

c2.BuildLegend()
c2.cd()
c2.Update()
c2.SaveAs("BfrAftrDeepDBTagger.pdf")
'''
