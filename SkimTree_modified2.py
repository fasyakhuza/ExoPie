		...
		jet2 = []
			...
			for jthinjet in pass_jet_index_cleaned:
				if (jthinjet > ithinjet) and (ak4deepcsv_[ithinjet] > 0.4941) and (ak4deepcsv_[jthinjet] > 0.4941):
					higgsmass = InvMass(ak4px_[ithinjet],ak4py_[ithinjet],ak4pz_[ithinjet],ak4e_[ithinjet],ak4px_[jthinjet],ak4py_[jthinjet],ak4pz_[jthinjet],ak4e_[jthinjet])
					jet1 = ithinjet
					jet2 = jthinjet
					st_higgsMass.push_back(higgsmass)
                                	j1index.push_back(jet1)
